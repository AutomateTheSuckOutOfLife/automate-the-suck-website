...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-10 h-10 bg-white dark:bg-dark-secondary rounded-full shadow-md flex items-center justify-center transition-all duration-500 hover:scale-110"
